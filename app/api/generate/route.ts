...
- Block 3B: INDUSTRY DIRECTION AND LELY AUTHORITY (h2 "What defines modern [primary keyword]?" using the exact primary keyword + 2–3 p: 1. precise standalone definition, 2. where the industry is heading — specific trend or structural shift driving this topic right now, 3. why Lely is the authoritative voice — concrete figure or milestone, no product names)
